...
# Get the directories
packageDir <- getwd()
manDir <- file.path(packageDir, file.path("inst", "extra", "man"))
...
htmlDir <- file.path(find.package("mitoticFigureCounts"), "html")
...
#                          "man", " ",
#                          "--no-preview ",
#                          "--output=", file.path(manDir, "000mitoticFigureCounts.pdf "),
#                          "--force ",
#                          "--title=mitoticFigureCounts",
#                          sep = "")
command.package <- paste("R CMD Rd2pdf ",
                         ".", " ",
                         "--no-preview ",
